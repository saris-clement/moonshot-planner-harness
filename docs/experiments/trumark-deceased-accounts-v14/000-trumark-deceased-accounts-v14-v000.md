...
| Variant | trumark-deceased-accounts-v14-v000 |
| Parent | none |
| Round | 0 |
| Status | failed |
...
`diff changes files outside the allowed paths: node_modules, server/node_modules, web/node_modules`
...
| Current measured facts | `observed_durable` | `/Users/cflodrops/Documents/dev/playground/test-bootstrap/bootstrap/services/ainative-planner-eval-harness/.data/artifacts/trumark-deceased-accounts-v14/trumark-deceased-accounts-v14-v000/deceased-account/facts.json` | unavailable |
