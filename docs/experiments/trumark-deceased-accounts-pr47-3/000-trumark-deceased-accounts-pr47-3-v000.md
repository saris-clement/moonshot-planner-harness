...
| Variant | trumark-deceased-accounts-pr47-3-v000 |
| Parent | none |
| Round | 0 |
| Status | failed |
...
| Patch | `/Users/cflodrops/Documents/dev/playground/test-bootstrap/bootstrap/services/ainative-planner-eval-harness/.data/artifacts/trumark-deceased-accounts-pr47-3/trumark-deceased-accounts-pr47-3-v000/variant.patch` |
| Image | `ainative-planner-eval:trumark-deceased-accounts-pr47-3-9c00fe3066-0` |
...
Recorded error: `interrupted integrated stack was archived before target evaluation completed`
...
| Current measured facts | `observed_durable` | `/Users/cflodrops/Documents/dev/playground/test-bootstrap/bootstrap/services/ainative-planner-eval-harness/.data/artifacts/trumark-deceased-accounts-pr47-3/trumark-deceased-accounts-pr47-3-v000/deceased-account/facts.json` | unavailable |
| Target-excluded comparisons | `deterministic_reconstruction` | `/Users/cflodrops/Documents/dev/playground/test-bootstrap/bootstrap/services/ainative-planner-eval-harness/.data/artifacts/trumark-deceased-accounts-pr47-3/trumark-deceased-accounts-pr47-3-v000/target-excluded/comparisons/` | failed |
